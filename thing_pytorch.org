...
2. *Broadcast rules* : a.  when operating on 2 arrays numpy compares the shape element-wise , starts with the trailing dimensions 
                           and works its way forward
                       b.  if they are equal 
                       c.  if one of them is 1 , 
                       d.  image(256*256*3) scale (3) result  , dimension with size 1 is stretched or copied 
