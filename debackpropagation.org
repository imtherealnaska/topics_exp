...
*USING BACK_PROP*:
1.<b>No need to know what hidden units are doing</b> . Instead of using desired activations to train hidden units ,use derivatives with-respect-to hidden activities
2.<b>Each activation can have  different effects on different output units</b> 
3.<b>error derivatives tells how fast error chnages with respect to the hidden activity</b></br>

<b>E</b>=0.5*(t<sub>j</sub>-y<sub>j</sub>)<sup>2</sup>
